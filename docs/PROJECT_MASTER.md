...
| DEC-111 | 2026-09-20 | Produce `docs/research/FEATURE_RESEARCH.md` (competitive feature research across Todoist, Things 3, TickTick, MS To Do, Sunsama, Motion, OmniFocus 4, Notion Tasks, Linear) and, from it, decision-complete plan documents for the next slices L-027 (sub-tasks), L-028 (task templates), L-029 (snooze/postpone), L-030 (Markdown notes), and L-031 (Kanban: Area board URL filters + new Project board). No implementation performed; slice order proposed in `BACKLOG.md` §6a awaits user selection. | Planned — documents committed to `opencode/develop` | `docs/research/FEATURE_RESEARCH.md`; `docs/planning/L-027_SUBTASKS_PLAN.md`; `docs/planning/L-028_TASK_TEMPLATES_PLAN.md`; `docs/planning/L-029_SNOOZE_PLAN.md`; `docs/planning/L-030_MARKDOWN_NOTES_PLAN.md`; `docs/planning/L-031_KANBAN_IMPROVEMENTS_PLAN.md` |
...
| `docs/planning/L-027_SUBTASKS_PLAN.md` | Implementation plan for L-027 sub-tasks (single-level nested Tasks with lifecycle cascade). | Planned; DEC-111 |
| `docs/planning/L-028_TASK_TEMPLATES_PLAN.md` | Implementation plan for L-028 task templates (define and apply). | Planned; DEC-111 |
