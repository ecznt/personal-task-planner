...
| `PATCH /users/me` | Session + CSRF + `If-Match` | Current User only. | Exactly one of confirmed account time zone or `inAppReminderNotificationsEnabled`; no email/owner field. Disabling requires explicit acknowledged consequences. | `200` updated User + new `ETag`; timed display changes do not rewrite stored instants, and preference changes do not delete reminders or Notification history. | `401`, `412`, `422`, `428`, `429`. | FR-045–FR-046, FR-091–FR-093, NFR-012, UXF-024, AC-016 |
