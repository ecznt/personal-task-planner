...
1. `cn()` - 37 edges
2. `AccountsRepository` - 33 edges
3. `AuthSecurityService` - 30 edges
4. `scripts` - 23 edges
...
Cohesion: 0.06
Nodes (62): ApiBody, ApiHeader, ApiOperation, ApiProperty, ApiResponse, ApiTags, secondsUntilWindowEnd(), RegisterAccountCommand (+54 more)

### Community 1 - "environment.ts"
Cohesion: 0.05
Nodes (40): AccountsWorkerModule, Module, EmailVerificationJobHandler, Inject, Injectable, VERIFICATION_EMAIL_DELIVERY, VerificationEmailDelivery, VerificationEmailMessage (+32 more)
...
### Community 6 - "registration.schema.ts"
Cohesion: 0.08
Nodes (25): generateOpenApi(), sortRecursively(), AppModule, Module, bootstrapApi(), parseRegistrationInput(), passwordSchema, RegistrationInput (+17 more)
...
### Community 9 - "login-form.tsx"
Cohesion: 0.12
Nodes (15): metadata, metadata, apiError(), AuthApiError, CsrfData, csrfQueryKey, fetchCsrf(), EmailVerificationForm() (+7 more)

### Community 10 - "Confirmed non-production OpenAPI generator profile"
Cohesion: 0.07
...
Cohesion: 0.16
Nodes (16): LoginCommand, LoginResult, LoginService, Injectable, ReadSessionService, SessionState, Injectable, AnonymousCsrfGuard (+8 more)
...
### Community 18 - "AccountsRepository"
Cohesion: 0.10
Nodes (8): Inject, Inject, Inject, Inject, Inject, AccountsRepository, Inject, Injectable
...
### Community 20 - "AuthSecurityService"
Cohesion: 0.22
Nodes (6): secondsUntilNextUtcHour(), argon2idOptions, AuthSecurityService, expandIpv6(), stripAddressDecoration(), Injectable
...
### Community 23 - "accounts.repository.ts"
Cohesion: 0.13
...
### Community 32 - "Phase 2 Final Readiness Audit"
Cohesion: 0.18
...
### Community 34 - "CsrfService"
Cohesion: 0.22
Nodes (3): CsrfService, Inject, Injectable

### Community 35 - "login.spec.ts"
Cohesion: 0.32
...
### Community 39 - "Graphify repository-local discovery and impact analysis"
Cohesion: 0.29
...
### Community 40 - "Architecture and Quality Strategy"
Cohesion: 0.33
...
### Community 57 - "email-verification-schema.ts"
Cohesion: 0.50
Nodes (3): EmailVerificationFormValues, emailVerificationSchema, verificationEmailRequestSchema

### Community 58 - "registration-schema.ts"
Cohesion: 0.50
Nodes (3): passwordSchema, registrationFormSchema, RegistrationFormValues

### Community 60 - "ARC-013 Backend-owned deterministic OpenAPI and generated-client pipeline"
Cohesion: 0.50
...
### Community 61 - "Weekly npm GitHub Actions and Docker dependency updates"
Cohesion: 0.67
...
### Community 64 - "Domain-Aligned Modular Monolith"
Cohesion: 0.67
...
- **Why does `AccountsRepository` connect `AccountsRepository` to `auth.controller.ts`, `environment.ts`, `CsrfService`, `login.spec.ts`, `session.controller.ts`, `AuthSecurityService`, `accounts.repository.ts`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `devDependencies` connect `devDependencies` to `package.json`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AuthSecurityService` connect `AuthSecurityService` to `auth.controller.ts`, `environment.ts`, `CsrfService`, `login.spec.ts`, `session.controller.ts`, `AccountsRepository`?**
